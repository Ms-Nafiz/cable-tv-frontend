...
import { FileText, DollarSign, Calendar, Filter, Printer, FileSpreadsheet } from 'lucide-react';
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left text-xs">
            ...
            <tbody className="divide-y divide-slate-800/60 text-slate-300">
              {loading ? (
                <tr><td colSpan="7" className="py-6 text-center text-cyan-400">Loading summary...</td></tr>
              ) : paginatedPayments.length === 0 ? (
                <tr><td colSpan="7" className="py-6 text-center text-slate-500">No collection records found.</td></tr>
              ) : (
